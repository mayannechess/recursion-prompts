...
var arraySum = function(array) {
	...
	if (len === 1) {
		...
		return arraySum(array.slice(len - 1)) + arraySum(array.slice(0, len - 1));
	}
};
...
var multiply = function(x, y) {
	...
	return (x > 0 ? y + multiply(x - 1, y) : x + multiply(y - 1, x));
};
...
var divide = function(x, y) {
	...
	return (x > 0 ? 1 + divide(x - y, y) : -1 - divide(x + y, y));
};
...
var fizzBuzz = function(n) {
	...
	return fizzBuzz(n - 1).concat([transform]);
};
